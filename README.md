...
1. 이미 해당 매치에 신청을 완료한 플레이어들의 실력 레벨 평균을 기준으로 score를 부여합니다. 
...
원하는 지역과 시간을 만족하는 매치들의 상세 페이지 html을 하나의 폴더에 저장합니다. (ex. 서울 중부/서남부, 6월 23일 19시~22시에 시작하는 매치, 총 23개 매치)<br>
